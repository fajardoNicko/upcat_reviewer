                    ...
                    {activeSection === 'account' && (
                        ...
                        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
                            ...
                            <div className="flex flex-col gap-4">
                                ...
                                <div className="flex flex-col gap-1">
                                    <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">Sign-in Method</p>
                                    <p className="text-sm text-gray-700 dark:text-gray-300">Google OAuth</p>
                                </div>
                                <div className="flex flex-col gap-1">
                                    <p className="text-xs text-gray-400 dark:text-gray-500 font-medium">Password</p>
                                    <p className="text-sm text-gray-700 dark:text-gray-300"> Managed by Google. Not Applicable</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
                            ...
                            <p className="text-xs text-gray-400 dark:text-gray-500 mb-4"> You w ill be redirected to the Login page. </p>
                            <button onClick={handleSignOut} className="bg-gray-100 dark:bg-gray-950 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-semibold px-4 py-2 rounded-xl transition-colors">Sign Out</button>\
                        </div>

                        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-red-100 dark:border-red-900 shadow-sm">
                            <h2 className="text-base font-semibold text-red-500 dark:text-red-400 mb-1">Delete Account</h2>
                            <p className="text-xs text-gray-400 dark:text-gray-500 mb-4">This will permanently delete your account and all your progress. This cannot be undone. </p>
                            {!showDeleteConfirm ? (
                                <button onClick={() => setShowDeleteConfirm(true)} className="bg-red-50 dark:bg-red-950 hover:bg-red-100 dark:hover:bg-red-900 text-red-500 dark:text-red-400 text-sm font-medium px-4 py-2 rounded-xl transition-colors">Delete Account</button>
                            ): (
                                <div className="flex items-center gap-3">
                                    <p className="text-sm text-gray-500 dark:text-gray-500"> Are you sure? </p>
                                    <button onClick={handleDeleteAccount}>
                                    Yes, delete
                                    </button>
                                    <button onClick={() => setShowDeleteConfirm(false)} className="bg-gray-100 dark:bg-gray-950 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-200 text-sm font-medium px-4 py-2 rounded-xl transition-colors">Cancel</button>
                                </div>
                            )}
                        </div>
                        </>
                    ...
                    {activeSection === 'notifications' && (
                        <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
                            ...
                            <div className="flex items-center justify-between py-3 border-b border-gray-50 dark:border-gray-700">
                                ...
                                <button onClick={() => setEmailNotifs(v=> !v)} className={`w-11 h-6 rounded-full transition-colors relative &{emailNotifs ? 'bg-violet-500': 'bg-gray-200 dark:bg-black'} `}>
                            ...
                            <div className="bg-white dark:bg-gray-950 rounded-2xl p-6 border border-gray-100 dark:border-gray-700 shadow-sm">
                                ...
                                <div className="flex flex-col gap-3">
                                    ...
                                    <div className="flex justify-between text-sm">
                                        ...
                                        <span className="text-gray-700 dark:text-gray-300 font-medium">React, Supabase, Tailwind</span>
                                    </div>
                                    </div>
                            </div>
